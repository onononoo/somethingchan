...
| path | what's there |
| --- | --- |
| `index.html` | the field guide: species tabs, commit graph, terminal, commands, math, threat meters, bestiary, atlas, history, comparison, quiz, hook simulator, `.git` explorer, css clock, /qa/, faq |
...
| --- | --- |
| html | every page |
| css | `css/somethingchan.css`, `css/lab.css`, `css/js.css` |
